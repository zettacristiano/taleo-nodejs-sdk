...
module.exports = {
	...
	employee: {
		...
		location: (id, callback) => object('employee', id, 'location', callback)
	},
	packet: {
	...
	location: {
		id: (id, callback) => object('location', id, null, callback),
		all: (callback) => object('location', null, null, callback)
	}
}
